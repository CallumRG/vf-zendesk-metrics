...
params: resend.Emails.SendParams = {
  "from": "Voiceflow Support <onboarding@resend.dev>",
  "to": ["callum.gillies@uwaterloo.ca"],
...
# Save the HTML content to a file for viewing in a browser
with open("zendesk_report_preview.html", "w") as file:
    file.write(html_content)

print("HTML file saved. Open 'zendesk_report_preview.html' in your browser to view.")